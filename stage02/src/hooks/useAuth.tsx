...
const clientId = import.meta.env.API_CLIENTID;//"f09fc6e876d136250151"; //import.meta.env.VITE_GITHUB_CLIENT_ID;
const redirectUri = import.meta.env.API_REDIRECT; //"http://localhost:3000"; //import.meta.env.VITE_GITHUB_CALLBACK_URL;
